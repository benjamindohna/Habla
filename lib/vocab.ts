...
// Re-exported from vocabSrsConstants for backwards compatibility —
// new callers should import directly from "./vocabSrsConstants" to
// avoid pulling lib/llm.ts into client bundles.
export type { VocabJudgement } from "./vocabSrsConstants";
...
// Constants + pure helpers (STAGE_INTERVALS_SECONDS, MAX_STAGE,
// formatStageInterval, projectNextStage) live in vocabSrsConstants.ts
// so client components can import them without pulling in this
// module's chatText dependency. Re-exported here for backwards
// compatibility — server callers can keep importing from "./vocab".
export {
  STAGE_INTERVALS_SECONDS,
  MAX_STAGE,
  formatStageInterval,
  projectNextStage,
} from "./vocabSrsConstants";
